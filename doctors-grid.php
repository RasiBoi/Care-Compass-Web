...
<head>
  ...
  <title>Doctors Grid - Medcity</title>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="mainNavigation">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav__item">
                    <a href="doctors-grid.php" class="nav__item-link active">Doctors</a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-xl-5">
            <h1 class="pagetitle__heading">Meet Our Expert Doctors</h1>
            <p class="pagetitle__desc">Browse our team of expert physicians, specializing in multiple fields of medical care.</p>
          </div>
        </div>
      </div>
    </section>
              ...
              echo '<div class="col-sm-6 col-md-4 col-lg-4">
                      <div class="member">
                        ...
                        <div class="member__info">
                          <h5 class="member__name"><a href="doctor-single.php?id=' . htmlspecialchars($doctor['id']) . '">' . htmlspecialchars($doctor['name']) . '</a></h5>
                          <p class="member__job">' . htmlspecialchars($doctor['specialty']) . '</p>
                          <p class="member__desc">' . htmlspecialchars(substr($doctor['bio'], 0, 100)) . '...</p>
                          <div class="mt-20 d-flex flex-wrap justify-content-between align-items-center">
                            <a href="doctor-single.php?id=' . htmlspecialchars($doctor['id']) . '" class="btn btn__secondary btn__link btn__rounded">
